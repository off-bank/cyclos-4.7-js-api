...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.CustomField();
  });
  ...
  describe('CustomField', function() {
    it('should create an instance of CustomField', function() {
      ...
      //var instane = new Cyclos471Api.CustomField();
      //expect(instance).to.be.a(Cyclos471Api.CustomField);
    });
    ...
    it('should have the property linkedEntityType (base name: "linkedEntityType")', function() {
      // uncomment below and update the code to test the property linkedEntityType
      //var instane = new Cyclos471Api.CustomField();
      //expect(instance).to.be();
    });
