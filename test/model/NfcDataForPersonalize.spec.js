...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.NfcDataForPersonalize();
  });
  ...
  describe('NfcDataForPersonalize', function() {
    it('should create an instance of NfcDataForPersonalize', function() {
      // uncomment below and update the code to test NfcDataForPersonalize
      //var instane = new Cyclos471Api.NfcDataForPersonalize();
      //expect(instance).to.be.a(Cyclos471Api.NfcDataForPersonalize);
    });
