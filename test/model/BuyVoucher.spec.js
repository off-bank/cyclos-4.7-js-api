...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.BuyVoucher();
  });
  ...
  describe('BuyVoucher', function() {
    it('should create an instance of BuyVoucher', function() {
      // uncomment below and update the code to test BuyVoucher
      //var instane = new Cyclos471Api.BuyVoucher();
      //expect(instance).to.be.a(Cyclos471Api.BuyVoucher);
    });
