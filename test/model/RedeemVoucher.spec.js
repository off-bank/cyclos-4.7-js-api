...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.RedeemVoucher();
  });
  ...
  describe('RedeemVoucher', function() {
    it('should create an instance of RedeemVoucher', function() {
      // uncomment below and update the code to test RedeemVoucher
      //var instane = new Cyclos471Api.RedeemVoucher();
      //expect(instance).to.be.a(Cyclos471Api.RedeemVoucher);
    });
