...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.VoucherRedeemResult();
  });
  ...
  describe('VoucherRedeemResult', function() {
    it('should create an instance of VoucherRedeemResult', function() {
      // uncomment below and update the code to test VoucherRedeemResult
      //var instane = new Cyclos471Api.VoucherRedeemResult();
      //expect(instance).to.be.a(Cyclos471Api.VoucherRedeemResult);
    });
