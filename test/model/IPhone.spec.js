...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.IPhone();
  });
  ...
  describe('IPhone', function() {
    it('should create an instance of IPhone', function() {
      // uncomment below and update the code to test IPhone
      //var instane = new Cyclos471Api.IPhone();
      //expect(instance).to.be.a(Cyclos471Api.IPhone);
    });
