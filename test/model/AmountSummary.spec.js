...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.AmountSummary();
  });
  ...
  describe('AmountSummary', function() {
    it('should create an instance of AmountSummary', function() {
      // uncomment below and update the code to test AmountSummary
      //var instane = new Cyclos471Api.AmountSummary();
      //expect(instance).to.be.a(Cyclos471Api.AmountSummary);
    });
