...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.AdManage();
  });
  ...
  describe('AdManage', function() {
    it('should create an instance of AdManage', function() {
      // uncomment below and update the code to test AdManage
      //var instane = new Cyclos471Api.AdManage();
      //expect(instance).to.be.a(Cyclos471Api.AdManage);
    });
