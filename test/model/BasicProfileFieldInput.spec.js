...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.BasicProfileFieldInput();
  });
  ...
  describe('BasicProfileFieldInput', function() {
    it('should create an instance of BasicProfileFieldInput', function() {
      // uncomment below and update the code to test BasicProfileFieldInput
      //var instane = new Cyclos471Api.BasicProfileFieldInput();
      //expect(instance).to.be.a(Cyclos471Api.BasicProfileFieldInput);
    });
