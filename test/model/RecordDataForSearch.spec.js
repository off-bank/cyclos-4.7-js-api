...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.RecordDataForSearch();
  });
  ...
  describe('RecordDataForSearch', function() {
    it('should create an instance of RecordDataForSearch', function() {
      // uncomment below and update the code to test RecordDataForSearch
      //var instane = new Cyclos471Api.RecordDataForSearch();
      //expect(instance).to.be.a(Cyclos471Api.RecordDataForSearch);
    });
