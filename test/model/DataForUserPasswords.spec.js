...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.DataForUserPasswords();
  });
  ...
  describe('DataForUserPasswords', function() {
    it('should create an instance of DataForUserPasswords', function() {
      // uncomment below and update the code to test DataForUserPasswords
      //var instane = new Cyclos471Api.DataForUserPasswords();
      //expect(instance).to.be.a(Cyclos471Api.DataForUserPasswords);
    });
