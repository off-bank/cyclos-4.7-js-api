...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.ForgottenPasswordRequest();
  });
  ...
  describe('ForgottenPasswordRequest', function() {
    it('should create an instance of ForgottenPasswordRequest', function() {
      // uncomment below and update the code to test ForgottenPasswordRequest
      //var instane = new Cyclos471Api.ForgottenPasswordRequest();
      //expect(instance).to.be.a(Cyclos471Api.ForgottenPasswordRequest);
    });
