...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.RecurringPaymentOccurrence();
  });
  ...
  describe('RecurringPaymentOccurrence', function() {
    it('should create an instance of RecurringPaymentOccurrence', function() {
      // uncomment below and update the code to test RecurringPaymentOccurrence
      //var instane = new Cyclos471Api.RecurringPaymentOccurrence();
      //expect(instance).to.be.a(Cyclos471Api.RecurringPaymentOccurrence);
    });
