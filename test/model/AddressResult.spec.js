...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.AddressResult();
  });
  ...
  describe('AddressResult', function() {
    it('should create an instance of AddressResult', function() {
      // uncomment below and update the code to test AddressResult
      //var instane = new Cyclos471Api.AddressResult();
      //expect(instance).to.be.a(Cyclos471Api.AddressResult);
    });
