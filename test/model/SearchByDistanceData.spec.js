...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.SearchByDistanceData();
  });
  ...
  describe('SearchByDistanceData', function() {
    it('should create an instance of SearchByDistanceData', function() {
      // uncomment below and update the code to test SearchByDistanceData
      //var instane = new Cyclos471Api.SearchByDistanceData();
      //expect(instance).to.be.a(Cyclos471Api.SearchByDistanceData);
    });
