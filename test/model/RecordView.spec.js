...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.RecordView();
  });
  ...
  describe('RecordView', function() {
    it('should create an instance of RecordView', function() {
      // uncomment below and update the code to test RecordView
      //var instane = new Cyclos471Api.RecordView();
      //expect(instance).to.be.a(Cyclos471Api.RecordView);
    });
