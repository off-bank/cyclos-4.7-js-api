...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.RecordBasePermissions();
  });
  ...
  describe('RecordBasePermissions', function() {
    it('should create an instance of RecordBasePermissions', function() {
      // uncomment below and update the code to test RecordBasePermissions
      //var instane = new Cyclos471Api.RecordBasePermissions();
      //expect(instance).to.be.a(Cyclos471Api.RecordBasePermissions);
    });
