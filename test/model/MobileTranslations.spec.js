...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.MobileTranslations();
  });
  ...
  describe('MobileTranslations', function() {
    it('should create an instance of MobileTranslations', function() {
      // uncomment below and update the code to test MobileTranslations
      //var instane = new Cyclos471Api.MobileTranslations();
      //expect(instance).to.be.a(Cyclos471Api.MobileTranslations);
    });
