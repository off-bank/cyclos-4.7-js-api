...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.Phone();
  });
  ...
  describe('Phone', function() {
    it('should create an instance of Phone', function() {
      ...
      //var instane = new Cyclos471Api.Phone();
      //expect(instance).to.be.a(Cyclos471Api.Phone);
    });
    ...
    it('should have the property normalizedNumber (base name: "normalizedNumber")', function() {
      // uncomment below and update the code to test the property normalizedNumber
      //var instane = new Cyclos471Api.Phone();
      //expect(instance).to.be();
    });
