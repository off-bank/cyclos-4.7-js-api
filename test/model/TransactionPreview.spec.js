...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.TransactionPreview();
  });
  ...
  describe('TransactionPreview', function() {
    it('should create an instance of TransactionPreview', function() {
      // uncomment below and update the code to test TransactionPreview
      //var instane = new Cyclos471Api.TransactionPreview();
      //expect(instance).to.be.a(Cyclos471Api.TransactionPreview);
    });

    it('should have the property confirmationMessage (base name: "confirmationMessage")', function() {
      // uncomment below and update the code to test the property confirmationMessage
      //var instane = new Cyclos471Api.TransactionPreview();
