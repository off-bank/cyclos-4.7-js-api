...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cyclos471Api.RecordBasicData();
  });
  ...
  describe('RecordBasicData', function() {
    it('should create an instance of RecordBasicData', function() {
      // uncomment below and update the code to test RecordBasicData
      //var instane = new Cyclos471Api.RecordBasicData();
      //expect(instance).to.be.a(Cyclos471Api.RecordBasicData);
    });
