...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Cyclos471Api.PhoneManage = factory(root.Cyclos471Api.ApiClient);
  }
  ...
  /**
   * The PhoneManage model module.
   * @module model/PhoneManage
   * @version 4.7.1
   */

  /**
   * Constructs a new <code>PhoneManage</code>.
   * Common fields for either creating or editing a phone
   * @alias module:model/PhoneManage
   * @class
   */
  ...
  /**
   * Constructs a <code>PhoneManage</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PhoneManage} obj Optional instance to populate.
   * @return {module:model/PhoneManage} The populated <code>PhoneManage</code> instance.
   */
