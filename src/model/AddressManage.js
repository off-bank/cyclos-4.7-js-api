...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GeographicalCoordinate'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GeographicalCoordinate'));
  } else {
    // Browser globals (root is window)
    if (!root.Cyclos471Api) {
      root.Cyclos471Api = {};
    }
    root.Cyclos471Api.AddressManage = factory(root.Cyclos471Api.ApiClient, root.Cyclos471Api.GeographicalCoordinate);
  }
}(this, function(ApiClient, GeographicalCoordinate) {
  'use strict';
  ...
  /**
   * The AddressManage model module.
   * @module model/AddressManage
   * @version 4.7.1
   */

  /**
   * Constructs a new <code>AddressManage</code>.
   * Common fields for either creating or editing an address
   * @alias module:model/AddressManage
   * @class
   */
  ...
  /**
   * Constructs a <code>AddressManage</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddressManage} obj Optional instance to populate.
   * @return {module:model/AddressManage} The populated <code>AddressManage</code> instance.
   */
