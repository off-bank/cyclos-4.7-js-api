...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Cyclos471Api.GroupForRegistration = factory(root.Cyclos471Api.ApiClient, root.Cyclos471Api.InternalNamedEntity);
  }
  ...
  /**
   * The GroupForRegistration model module.
   * @module model/GroupForRegistration
   * @version 4.7.1
   */

  /**
   * Constructs a new <code>GroupForRegistration</code>.
   * Contains data for a possible group for user registration
   * @alias module:model/GroupForRegistration
   * @class
  ...
  /**
   * Constructs a <code>GroupForRegistration</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GroupForRegistration} obj Optional instance to populate.
   * @return {module:model/GroupForRegistration} The populated <code>GroupForRegistration</code> instance.
   */
