...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Cyclos471Api.AddressNew = factory(root.Cyclos471Api.ApiClient, root.Cyclos471Api.AddressManage, root.Cyclos471Api.GeographicalCoordinate);
  }
  ...
  /**
   * The AddressNew model module.
   * @module model/AddressNew
   * @version 4.7.1
   */

  /**
   * Constructs a new <code>AddressNew</code>.
   * Fields for a new address. The actually used and required fields depend on the user configuration. 
   * @alias module:model/AddressNew
   * @class
  ...
  /**
   * Constructs a <code>AddressNew</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddressNew} obj Optional instance to populate.
   * @return {module:model/AddressNew} The populated <code>AddressNew</code> instance.
   */
